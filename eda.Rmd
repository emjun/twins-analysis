...
# abnormalities
twins_ca_anen<-twins_only%>%group_by(number)%>%summarise(ca_anen_pair=paste0(ca_anen[1],ca_anen[2]),
ca_anen_pairb=ifelse(ca_anen_pair %in% c("YN","NY"),1,ifelse(ca_anen_pair == "YY", 2, 0)),)
